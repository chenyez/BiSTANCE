# nohup bash ./train_w_challenge_multi_lang_plms_subtaskB.sh > train_w_challenge_multi_lang_plms_subtaskB_results.log 2>&1 &

### mbert
for config in "../config/config-mbert_base.txt"
# for config in "../config/config-xlmroberta_base.txt"
# for config in "../config/config-mbart_large.txt"
...
# for config in "../config/config-mbert_base.txt"
# for config in "../config/config-xlmroberta_base.txt"
for config in "../config/config-mbert_base.txt" #"../config/config-mt5_base.txt"
# for config in "../config/config-mt5_base.txt"
do
    echo "start training config ${config}......"
