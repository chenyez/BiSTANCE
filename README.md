# BiSTANCE
This repository includes data and code for the Bi-STANCE dataset (recently accepted as an ACL 2025 main conference paper).

Please cite us using:

@inproceedings{zhao-caragea-2025-bilingual,
    ...
    url = "https://aclanthology.org/2025.acl-long.1446/",
    doi = "10.18653/v1/2025.acl-long.1446",
    pages = "29900--29919",
